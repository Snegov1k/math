...
START_TEST(s21_tan_unusual_test) {
...
Suite *s21_tan_suite() {
  ...
  tcase_add_test(tc, s21_tan_usual_test);
  tcase_add_test(tc, s21_tan_unusual_test);
...
int main() {
  ...
  runner = srunner_create(s21_tan_suite());
